...
import com.mangaschool_app.cardview.api.Client;
import com.mangaschool_app.cardview.api.Service;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews(){
        ...
        try {
            ...
            Glide.with(this).load(R.drawable.coverandroid).into((ImageView) findViewById(R.id.backdrop));
        ...
        try{
            ...
            call.enqueue(new Callback<AlbumsResponse>() {
                ...
                public void onFailure(Call<AlbumsResponse> call, Throwable t) {
                    ...
                    Toast.makeText(MainActivity.this, "Check Connection (u.u) )", Toast.LENGTH_SHORT).show();
